...
replace (
	...
	github.com/HyperService-Consortium/go-uip => github.com/HyperService-Consortium/go-uip v0.0.0-20200423085134-7f1d4a0ec024
)
...
require (
	...
	github.com/HyperService-Consortium/NSB v0.7.4-0.20200426105821-4abf2a2d8743
